function SliderTouchController(slider, sliderForegrounds, sliderBackgrounds, sliderButtons, sliderActive) {
    var threshold = .1;
    var foreground, background, buttons, active, isDragging, isTapping, startX, startY, endX, endY, translateX, translateY, lockY, targetTouches;
    var index = 0;
    var offsetX = 0;
    var activeOffsetX = 0;
...
function domLoaded() {
    ...
    if ("ontouchstart" in window) {
        var sliderController = new SliderTouchController(document.getElementById("slider"), document.getElementsByClassName("slider-foregrounds"), document.getElementsByClassName("slider-backgrounds"), document.getElementsByClassName("button"), document.getElementsByClassName("active")).attach();
    }
}
